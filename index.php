...
<html lang="de">
  ...
  <body>
    ...
    <article>
      <br>
      <form action="upload.php?<?php echo "kode=".$_GET['kode'] ?>" method="post" enctype="multipart/form-data">
...
foreach ($entries as $entry => $is_dir) {
    ...
    printf('        <li class="%s"><a href="uploads/%s">%s</a></li>' . "\n",
        $class_name, $escaped_entry, $escaped_entry);
}
?>
      </ol>
      <br>
      <form action="clean.php?<?php echo "kode=".$_GET['kode'] ?>" method="post" enctype="multipart/form-data">
